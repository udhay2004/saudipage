  ...
  return (
    <section id="why-saudi" className="relative py-16 lg:py-20 bg-[#05080c] border-t border-[#c8a45d]/15 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between pb-12 mb-14 border-b border-white/10 gap-6">
          <div>
        ...
        <div className="relative rounded-2xl border border-[#c8a45d]/20 bg-[#071a2b]/40 backdrop-blur-md p-8 lg:p-12 mb-16 shadow-[0_20px_50px_rgba(5,8,12,0.8)]">
          {/* Top Architectural Aperture Coordinates */}
          <div className="flex items-center justify-between pb-6 border-b border-white/5 text-[10px] font-mono-tech tracking-wider text-[#c8a45d]/70">
            <span className="flex items-center gap-2">
              <span className="w-2 h-2 rounded-full bg-[#0b8f5a] animate-ping" />
              GATEWAY STATE: UNLOCKED
            </span>
            <span>KINGDOM OF SAUDI ARABIA · VISION 2030</span>
            <span className="hidden sm:inline">COORDINATES: 24°42&apos;49&quot;N 46°40&apos;22&quot;E</span>
          </div>
          ...
          <div className="flex items-center gap-6 py-6 border-b border-white/5">
            <button
              ...
              className={`text-xs tracking-[0.2em] uppercase font-mono-tech pb-1 transition-all ${
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 pt-4">
          <div className="border-t border-[#c8a45d]/30 pt-4">
            <div className="font-editorial text-3xl sm:text-4xl text-[#f4f1e8] mb-1 font-light">
              $3.2T
            </div>
            <div className="text-[11px] font-mono-tech text-[#c8a45d] uppercase tracking-wider mb-1">
              Investment Pipeline
            </div>
            <p className="text-[11px] text-[#f4f1e8]/60 font-light leading-relaxed">
              Total National Investment Strategy allocation through Vision 2030.
            </p>
          </div>

          <div className="border-t border-[#0b8f5a]/40 pt-4">
            <div className="font-editorial text-3xl sm:text-4xl text-[#f4f1e8] mb-1 font-light">
              100%
            </div>
            <div className="text-[11px] font-mono-tech text-[#0b8f5a] uppercase tracking-wider mb-1">
              Foreign Ownership
            </div>
            <p className="text-[11px] text-[#f4f1e8]/60 font-light leading-relaxed">
          ...
          <div className="border-t border-[#f4f1e8]/20 pt-4">
            <div className="font-editorial text-3xl sm:text-4xl text-[#f4f1e8] mb-1 font-light">
              #01
            </div>
            <div className="text-[11px] font-mono-tech text-[#f4f1e8]/80 uppercase tracking-wider mb-1">
